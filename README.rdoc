...
__WARNING:__ This version has been hacked up to work with the precise
build of LibGD used by the `grlibs-stopwatch`.  The original version
of this is at http://github.com/dark-panda/gd2-ffij ; you probably
that instead.
